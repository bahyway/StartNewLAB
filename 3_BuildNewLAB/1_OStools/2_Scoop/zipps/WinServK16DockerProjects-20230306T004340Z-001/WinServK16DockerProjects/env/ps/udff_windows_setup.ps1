...
# BF : 
Add-ChocolateyPackage -PackageName "ms-vscode.PowerShell-Preview"
...
# Docker Tools
Add-ChocolateyPackage -PackageName "ms-azuretools.vscode-docker"
Add-ChocolateyPackage -PackageName "formulahendry.docker-explorer"
Add-ChocolateyPackage -PackageName "formulahendry.docker-extension-pack"
Add-ChocolateyPackage -PackageName "george3447.docker-run"
Add-ChocolateyPackage -PackageName "TqrHsn.vscode-docker-registry-explorer"
Add-ChocolateyPackage -PackageName "sandipchitale.docker-dive"
Add-ChocolateyPackage -PackageName "jonrad.docker-diary-vscode"
Add-ChocolateyPackage -PackageName "david-reis.dockerlive"
Add-ChocolateyPackage -PackageName "balaprasanna.bala-bks-docker-snippets"
Add-ChocolateyPackage -PackageName "jeff-hykin.better-dockerfile-syntax"
Add-ChocolateyPackage -PackageName "QuentinGruber.dockerfiletemplate"
Add-ChocolateyPackage -PackageName "redhat.vscode-yaml"
Add-ChocolateyPackage -PackageName "haranjackson.vscode-docker-ipython"
Add-ChocolateyPackage -PackageName "ms-vscode-remote.remote-containers"
Add-ChocolateyPackage -PackageName "Nodixo.pytest-in-docker"
Add-ChocolateyPackage -PackageName "foxundermoon.shell-format"
Add-ChocolateyPackage -PackageName "exiasr.hadolint"
Add-ChocolateyPackage -PackageName "marquesmps.dockerfile-validator"
Add-ChocolateyPackage -PackageName "aaron-bond.better-comments"
Add-ChocolateyPackage -PackageName "okteto.remote-kubernetes"
Add-ChocolateyPackage -PackageName "ilevine.squash"
Add-ChocolateyPackage -PackageName "bmuskalla.vscode-tldr"
Add-ChocolateyPackage -PackageName "2ndshift.fresh-material"
Add-ChocolateyPackage -PackageName "Shan.code-settings-sync"
